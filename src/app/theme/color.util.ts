 ...
 * paleta. Incluye las conversiones, el contraste WCAG y las medidas
 * perceptuales usadas para validar las series de gráficos.
 */
...
/** Canal sRGB 0–1 a luz lineal, compartido por WCAG y OKLab. */
...
export function luminancia(hex: string): number | null {
  ...
  return (
    0.2126 * aLineal(rgb.r / 255) +
    0.7152 * aLineal(rgb.g / 255) +
    0.0722 * aLineal(rgb.b / 255)
  );
}
