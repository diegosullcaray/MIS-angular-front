/** Rampa secuencial (un solo hue, pasos monótonos) para el heatmap de Usabilidad — validada con `validate_palette.js --ordinal` de la skill `dataviz` contra la superficie real de tarjeta del Host (`--mis-panel-bg` claro/oscuro). */
