...
import { ResumenMovilidadComercialComponent } from './resumen-movilidad-comercial.component';
...
describe('ResumenMovilidadComercialComponent', () => {
  ...
  beforeEach(() => {
    servicioSpy = {
      comercial: vi.fn().mockReturnValue(of({ headers: [], body: [], rows: [], items: [], total: 0, kpis: {}, estadoRenovacion: { categorias: [], series: [] }, antiguedadCliente: { categorias: [], series: [] }, cards: [], table: [] })),
    };

    TestBed.configureTestingModule({
      imports: [ResumenMovilidadComercialComponent],
      providers: [
        MessageService,
        {
  ...
  it('se crea correctamente', () => {
    const fixture = TestBed.createComponent(ResumenMovilidadComercialComponent);
