...
import { SeguimientoReprogramadosComponent } from './seguimiento-reprogramados.component';
...
describe('SeguimientoReprogramadosComponent', () => {
  ...
  beforeEach(() => {
    servicioSpy = {
      seguimientoReprogramados: vi.fn().mockReturnValue(of({ headers: [], body: [], rows: [], items: [], total: 0, kpis: {}, estadoRenovacion: { categorias: [], series: [] }, antiguedadCliente: { categorias: [], series: [] }, cards: [], table: [] })),
    };

    TestBed.configureTestingModule({
      imports: [SeguimientoReprogramadosComponent],
      providers: [
        MessageService,
        {
  ...
  it('se crea correctamente', () => {
    const fixture = TestBed.createComponent(SeguimientoReprogramadosComponent);
