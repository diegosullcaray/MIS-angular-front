...
import { AppClienteHomeBankingComponent } from './app-cliente-home-banking.component';
...
describe('AppClienteHomeBankingComponent', () => {
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [AppClienteHomeBankingComponent],
      providers: [
        MessageService,
        {
  ...
  it('se crea correctamente', () => {
    const fixture = TestBed.createComponent(AppClienteHomeBankingComponent);
