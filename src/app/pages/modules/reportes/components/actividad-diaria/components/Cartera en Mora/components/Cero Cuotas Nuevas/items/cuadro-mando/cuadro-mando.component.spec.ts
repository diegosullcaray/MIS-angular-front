...
import { CeroCuotasCuadroMandoComponent } from './cuadro-mando.component';
...
describe('CeroCuotasCuadroMandoComponent', () => {
  ...
  beforeEach(() => {
    servicioSpy = {
      cuadroMando: vi.fn().mockReturnValue(of([])),
    };

    TestBed.configureTestingModule({
      imports: [CeroCuotasCuadroMandoComponent],
      providers: [
        MessageService,
        {
  ...
  it('se crea correctamente', () => {
    const fixture = TestBed.createComponent(CeroCuotasCuadroMandoComponent);
