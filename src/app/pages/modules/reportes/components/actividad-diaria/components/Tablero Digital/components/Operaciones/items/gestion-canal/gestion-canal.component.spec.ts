...
import { GestionCanalComponent } from './gestion-canal.component';
...
describe('GestionCanalComponent', () => {
  ...
  beforeEach(() => {
    servicioSpy = {
      gestionCanal: vi.fn().mockReturnValue(of({ headers: [], body: [], rows: [], items: [], total: 0, kpis: {}, estadoRenovacion: { categorias: [], series: [] }, antiguedadCliente: { categorias: [], series: [] }, cards: [], table: [] })),
    };

    TestBed.configureTestingModule({
      imports: [GestionCanalComponent],
      providers: [
        MessageService,
        {
  ...
  it('se crea correctamente', () => {
    const fixture = TestBed.createComponent(GestionCanalComponent);
