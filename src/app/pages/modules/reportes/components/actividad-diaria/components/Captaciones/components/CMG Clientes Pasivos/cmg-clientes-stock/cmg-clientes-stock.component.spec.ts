...
describe('CmgClientesStockComponent', () => {
  ...
  beforeEach(() => {
    servicioSpy = {
      stock: vi.fn().mockReturnValue(of({ headers: [], body: [], rows: [], items: [], total: 0, kpis: {}, estadoRenovacion: { categorias: [], series: [] }, antiguedadCliente: { categorias: [], series: [] }, cards: [], table: [] })),
    };
