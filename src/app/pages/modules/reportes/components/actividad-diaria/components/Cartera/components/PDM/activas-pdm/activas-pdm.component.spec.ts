...
import { ActivasPdmComponent } from './activas-pdm.component';
...
describe('ActivasPdmComponent', () => {
  ...
  beforeEach(() => {
    servicioSpy = {
      activasPdm: vi.fn().mockReturnValue(of({ headers: [], body: [], rows: [], items: [], total: 0, kpis: {}, estadoRenovacion: { categorias: [], series: [] }, antiguedadCliente: { categorias: [], series: [] }, cards: [], table: [] })),
    };

    TestBed.configureTestingModule({
      imports: [ActivasPdmComponent],
      providers: [
        MessageService,
        {
  ...
  it('se crea correctamente', () => {
    const fixture = TestBed.createComponent(ActivasPdmComponent);
