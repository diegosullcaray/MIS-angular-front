...
import { SeguimientoPdmComponent } from './seguimiento-pdm.component';
...
describe('SeguimientoPdmComponent', () => {
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [SeguimientoPdmComponent],
      providers: [
        MessageService,
        {
  ...
  it('se crea correctamente', () => {
    const fixture = TestBed.createComponent(SeguimientoPdmComponent);
