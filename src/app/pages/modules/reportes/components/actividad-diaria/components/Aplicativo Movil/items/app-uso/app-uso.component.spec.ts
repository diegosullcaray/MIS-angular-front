...
import { AppUsoComponent } from './app-uso.component';
...
describe('AppUsoComponent', () => {
  ...
  beforeEach(() => {
    servicioSpy = {
      usoApp: vi.fn().mockReturnValue(of({ headers: [], body: [], rows: [], items: [], total: 0, kpis: {}, estadoRenovacion: { categorias: [], series: [] }, antiguedadCliente: { categorias: [], series: [] }, cards: [], table: [] })),
    };

    TestBed.configureTestingModule({
      imports: [AppUsoComponent],
      providers: [
        MessageService,
        {
      ...
      useValue: {
        ...
        { provide: AplicativoMovilService, useValue: servicioSpy },
      ],
    });
  });
