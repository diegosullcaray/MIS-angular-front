...
import { RankingAutonomiasComponent } from './ranking-autonomias.component';
...
describe('RankingAutonomiasComponent', () => {
  ...
  beforeEach(() => {
    servicioSpy = {
      rankingAutonomias: vi.fn().mockReturnValue(of({ headers: [], body: [], rows: [], items: [], total: 0, kpis: {}, estadoRenovacion: { categorias: [], series: [] }, antiguedadCliente: { categorias: [], series: [] }, cards: [], table: [] })),
    };

    TestBed.configureTestingModule({
      imports: [RankingAutonomiasComponent],
      providers: [
        MessageService,
        {
  ...
  it('se crea correctamente', () => {
    const fixture = TestBed.createComponent(RankingAutonomiasComponent);
