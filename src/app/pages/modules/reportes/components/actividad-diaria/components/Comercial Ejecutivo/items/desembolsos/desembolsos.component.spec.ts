...
import { DesembolsosEjecutivoComponent } from './desembolsos.component';
...
describe('DesembolsosEjecutivoComponent', () => {
  ...
  beforeEach(() => {
    servicioSpy = {
      desembolsos: vi.fn().mockReturnValue(of({ headers: [], body: [], rows: [], items: [], total: 0, kpis: {}, estadoRenovacion: { categorias: [], series: [] }, antiguedadCliente: { categorias: [], series: [] }, cards: [], table: [] })),
    };

    TestBed.configureTestingModule({
      imports: [DesembolsosEjecutivoComponent],
      providers: [
        MessageService,
        {
  ...
  it('se crea correctamente', () => {
    const fixture = TestBed.createComponent(DesembolsosEjecutivoComponent);
