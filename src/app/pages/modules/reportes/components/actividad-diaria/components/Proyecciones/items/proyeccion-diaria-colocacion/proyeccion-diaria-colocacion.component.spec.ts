...
import { ProyeccionDiariaColocacionComponent } from './proyeccion-diaria-colocacion.component';
...
describe('ProyeccionDiariaColocacionComponent', () => {
  ...
  beforeEach(() => {
    servicioSpy = {
      diariaColocacion: vi.fn().mockReturnValue(of([])),
    };

    TestBed.configureTestingModule({
      imports: [ProyeccionDiariaColocacionComponent],
      providers: [
        MessageService,
        {
  ...
  it('se crea correctamente', () => {
    const fixture = TestBed.createComponent(ProyeccionDiariaColocacionComponent);
