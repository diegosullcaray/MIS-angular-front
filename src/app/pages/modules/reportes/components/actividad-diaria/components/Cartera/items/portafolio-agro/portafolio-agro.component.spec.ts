...
import { PortafolioAgroComponent } from './portafolio-agro.component';
...
describe('PortafolioAgroComponent', () => {
  ...
  beforeEach(() => {
    servicioSpy = {
      portafolioAgro: vi.fn().mockReturnValue(of({ headers: [], body: [], rows: [], items: [], total: 0, kpis: {}, estadoRenovacion: { categorias: [], series: [] }, antiguedadCliente: { categorias: [], series: [] }, cards: [], table: [] })),
    };

    TestBed.configureTestingModule({
      imports: [PortafolioAgroComponent],
      providers: [
        MessageService,
        {
  ...
  it('se crea correctamente', () => {
    const fixture = TestBed.createComponent(PortafolioAgroComponent);
