...
import { CmgCarteraMoraSinImpulsoComponent } from './cmg-cartera-mora-sin-impulso.component';
...
describe('CmgCarteraMoraSinImpulsoComponent', () => {
  ...
  beforeEach(() => {
    servicioSpy = {
      cmgMoraSinImpulso: vi.fn().mockReturnValue(of({ headers: [], body: [], rows: [], items: [], total: 0, kpis: {}, estadoRenovacion: { categorias: [], series: [] }, antiguedadCliente: { categorias: [], series: [] }, cards: [], table: [] })),
    };

    TestBed.configureTestingModule({
      imports: [CmgCarteraMoraSinImpulsoComponent],
      providers: [
        MessageService,
        {
  ...
  it('se crea correctamente', () => {
    const fixture = TestBed.createComponent(CmgCarteraMoraSinImpulsoComponent);
