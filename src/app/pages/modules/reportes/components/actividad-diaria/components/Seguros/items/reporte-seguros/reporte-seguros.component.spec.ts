...
import { ReporteSegurosComponent } from './reporte-seguros.component';
...
describe('ReporteSegurosComponent', () => {
  ...
  beforeEach(() => {
    servicioSpy = {
      reporteSeguros: vi.fn().mockReturnValue(of([])),
    };

    TestBed.configureTestingModule({
      imports: [ReporteSegurosComponent],
      providers: [
        MessageService,
        {
  ...
  it('se crea correctamente', () => {
    const fixture = TestBed.createComponent(ReporteSegurosComponent);
