...
import { ComiteCreditosDiarioComponent } from './comite-creditos-diario.component';
...
describe('ComiteCreditosDiarioComponent', () => {
  ...
  beforeEach(() => {
    servicioSpy = {
      comiteCreditos: vi.fn().mockReturnValue(of({ headers: [], body: [], rows: [], items: [], total: 0, kpis: {}, estadoRenovacion: { categorias: [], series: [] }, antiguedadCliente: { categorias: [], series: [] }, cards: [], table: [] })),
    };

    TestBed.configureTestingModule({
      imports: [ComiteCreditosDiarioComponent],
      providers: [
        MessageService,
        {
  ...
  it('se crea correctamente', () => {
    const fixture = TestBed.createComponent(ComiteCreditosDiarioComponent);
