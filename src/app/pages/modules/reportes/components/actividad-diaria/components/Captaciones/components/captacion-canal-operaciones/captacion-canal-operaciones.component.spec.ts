...
import { CaptacionCanalOperacionesComponent } from './captacion-canal-operaciones.component';
...
describe('CaptacionCanalOperacionesComponent', () => {
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [CaptacionCanalOperacionesComponent],
      providers: [
        MessageService,
        {
      ...
      useValue: {
        ...
        { provide: CaptacionCanalOperacionesService, useValue: servicioSpy },
      ],
    });
  });

  it('se crea correctamente', () => {
    const fixture = TestBed.createComponent(CaptacionCanalOperacionesComponent);
