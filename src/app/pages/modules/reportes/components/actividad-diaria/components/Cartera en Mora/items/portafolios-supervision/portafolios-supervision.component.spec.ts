...
import { PortafoliosSupervisionComponent } from './portafolios-supervision.component';
...
describe('PortafoliosSupervisionComponent', () => {
  ...
  beforeEach(() => {
    servicioSpy = {
      portafoliosSupervision: vi.fn().mockReturnValue(of([])),
    };

    TestBed.configureTestingModule({
      imports: [PortafoliosSupervisionComponent],
      providers: [
        MessageService,
        {
  ...
  it('se crea correctamente', () => {
    const fixture = TestBed.createComponent(PortafoliosSupervisionComponent);
