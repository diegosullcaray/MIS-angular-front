...
import { RecaudosServiciosComponent } from './recaudos-servicios.component';
...
describe('RecaudosServiciosComponent', () => {
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      imports: [RecaudosServiciosComponent],
      providers: [
        MessageService,
        {
      ...
      useValue: {
        ...
        { provide: RecaudosServiciosService, useValue: servicioSpy },
      ],
    });
  });

  it('se crea correctamente', () => {
    const fixture = TestBed.createComponent(RecaudosServiciosComponent);
