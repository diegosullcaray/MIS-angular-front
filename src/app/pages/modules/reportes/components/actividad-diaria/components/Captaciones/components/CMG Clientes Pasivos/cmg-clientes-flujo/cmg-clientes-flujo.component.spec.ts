...
describe('CmgClientesFlujoComponent', () => {
  ...
  beforeEach(() => {
    servicioSpy = {
      flujo: vi.fn().mockReturnValue(of({ headers: [], body: [], rows: [], items: [], total: 0, kpis: {}, estadoRenovacion: { categorias: [], series: [] }, antiguedadCliente: { categorias: [], series: [] }, cards: [], table: [] })),
    };
