...
import { SeguimientoPortafolioComponent } from './seguimiento-portafolio.component';
...
describe('SeguimientoPortafolioComponent', () => {
  ...
  beforeEach(() => {
    servicioSpy = {
      seguimientoPortafolio: vi.fn().mockReturnValue(of([])),
    };

    TestBed.configureTestingModule({
      imports: [SeguimientoPortafolioComponent],
      providers: [
        MessageService,
        {
  ...
  it('se crea correctamente', () => {
    const fixture = TestBed.createComponent(SeguimientoPortafolioComponent);
