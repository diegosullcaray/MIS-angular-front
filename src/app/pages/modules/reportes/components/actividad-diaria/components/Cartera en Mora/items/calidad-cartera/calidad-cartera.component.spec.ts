...
import { CalidadCarteraComponent } from './calidad-cartera.component';
...
describe('CalidadCarteraComponent', () => {
  ...
  beforeEach(() => {
    servicioSpy = {
      calidadCartera: vi.fn().mockReturnValue(of([])),
    };

    TestBed.configureTestingModule({
      imports: [CalidadCarteraComponent],
      providers: [
        MessageService,
        {
  ...
  it('se crea correctamente', () => {
    const fixture = TestBed.createComponent(CalidadCarteraComponent);
