...
import { ReportePagoPuntualComponent } from './reporte-pago-puntual.component';
...
describe('ReportePagoPuntualComponent', () => {
  ...
  beforeEach(() => {
    servicioSpy = {
      reportePagoPuntual: vi.fn().mockReturnValue(of({ headers: [], body: [], rows: [], items: [], total: 0, kpis: {}, estadoRenovacion: { categorias: [], series: [] }, antiguedadCliente: { categorias: [], series: [] }, cards: [], table: [] })),
    };

    TestBed.configureTestingModule({
      imports: [ReportePagoPuntualComponent],
      providers: [
        MessageService,
        {
  ...
  it('se crea correctamente', () => {
    const fixture = TestBed.createComponent(ReportePagoPuntualComponent);
