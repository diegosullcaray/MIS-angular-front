...
import { TopVariablesRiesgoComponent } from './top-variables-riesgo.component';
...
describe('TopVariablesRiesgoComponent', () => {
  ...
  beforeEach(() => {
    servicioSpy = {
      topVariablesRiesgo: vi.fn().mockReturnValue(of([])),
    };

    TestBed.configureTestingModule({
      imports: [TopVariablesRiesgoComponent],
      providers: [
        MessageService,
        {
  ...
  it('se crea correctamente', () => {
    const fixture = TestBed.createComponent(TopVariablesRiesgoComponent);
