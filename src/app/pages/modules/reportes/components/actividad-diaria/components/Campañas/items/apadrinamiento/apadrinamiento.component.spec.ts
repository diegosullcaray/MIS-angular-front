...
describe('ApadrinamientoComponent', () => {
  ...
  beforeEach(() => {
    servicioSpy = {
      apadrinamiento: vi.fn().mockReturnValue(of({ headers: [], body: [], rows: [], items: [], total: 0, kpis: {}, estadoRenovacion: { categorias: [], series: [] }, antiguedadCliente: { categorias: [], series: [] }, cards: [], table: [] })),
    };
    ...
    TestBed.configureTestingModule({
      ...
      useValue: {
        ...
        { provide: CampanasService, useValue: servicioSpy },
      ],
    });
  });

  it('se crea correctamente', () => {
    const fixture = TestBed.createComponent(ApadrinamientoComponent);
