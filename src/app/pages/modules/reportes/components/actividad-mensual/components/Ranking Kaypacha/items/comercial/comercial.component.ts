...
/** "Ranking Kaypacha Comercial" (`leg/com/rma/adm/rank-kay`). */
@Component({
  selector: 'app-mensual-ranking-kaypacha-comercial',
  standalone: true,
  imports: [ReporteSimpleComponent, SelectFiltroComponent],
  templateUrl: './comercial.component.html',
  styleUrl: './comercial.component.css',
})
export class RankingKaypachaComercialComponent extends ReporteSimpleBase {
  ...
  protected override consultar(nodo: NodoConsulta): Observable<ReporteBloqueUnico> {
    return this.servicio.rankingKaypachaComercial(nodo, this.fechaBase());
  }
}
