...
describe('DashboardCeroCuotaNuevaComponent', () => {
  ...
  it('debe crearse correctamente', () => {
    const fixture = TestBed.createComponent(DashboardCeroCuotaNuevaComponent);
    expect(fixture.componentInstance).toBeTruthy();
  });

  it('al seleccionar nivel debe llamar a dashboardCeroCuotaNueva', () => {
    const fixture = TestBed.createComponent(DashboardCeroCuotaNuevaComponent);
