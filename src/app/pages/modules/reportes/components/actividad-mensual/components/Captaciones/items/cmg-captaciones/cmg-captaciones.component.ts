...
/** "CMG Captaciones" (`leg/com/rma/adm/cmg-capta`). */
@Component({
  selector: 'app-mensual-cmg-captaciones',
  standalone: true,
...
export class CmgCaptacionesComponent extends ReporteSimpleBase {
  ...
  protected override consultar(nodo: NodoConsulta): Observable<ReporteBloqueUnico> {
    return this.servicio.cmgCaptaciones(nodo, this.fechaBase());
  }
}
