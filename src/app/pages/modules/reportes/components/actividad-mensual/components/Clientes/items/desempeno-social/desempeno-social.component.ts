...
/** "Desempeño Social" (`leg/com/rma/adm/desemp-social`). */
@Component({
  selector: 'app-mensual-desempeno-social',
  standalone: true,
...
export class DesempenoSocialComponent extends ReporteSimpleBase {
  ...
  protected override consultar(nodo: NodoConsulta): Observable<ReporteBloqueUnico> {
    return this.servicio.desempenoSocial(nodo, this.fechaBase());
  }
}
