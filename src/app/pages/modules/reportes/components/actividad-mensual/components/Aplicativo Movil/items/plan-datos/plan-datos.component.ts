...
/** "Plan de Datos" (`leg/com/rma/adm/app_uso_m`). */
@Component({
  selector: 'app-mensual-plan-datos',
  standalone: true,
...
export class PlanDatosComponent extends ReporteSimpleBase {
  ...
  protected override consultar(nodo: NodoConsulta): Observable<ReporteBloqueUnico> {
    return this.servicio.planDatos(nodo, this.fechaBase());
  }
}
