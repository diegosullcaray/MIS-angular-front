...
/** "CMG Clientes Activo" (`leg/com/rma/adm/cmg-cli`). */
@Component({
  selector: 'app-mensual-cmg-clientes-activo',
  standalone: true,
  imports: [ReporteSimpleComponent, SelectFiltroComponent],
  templateUrl: './cmg-clientes-activo.component.html',
  styleUrl: './cmg-clientes-activo.component.css',
})
export class CmgClientesActivoComponent extends ReporteSimpleBase {
  ...
  protected override consultar(nodo: NodoConsulta): Observable<ReporteBloqueUnico> {
    return this.servicio.cmgClientesActivo(nodo, this.fechaBase());
  }
}
