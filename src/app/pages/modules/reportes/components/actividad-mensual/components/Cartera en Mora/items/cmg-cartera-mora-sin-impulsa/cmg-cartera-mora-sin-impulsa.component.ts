...
/** "CMG Cartera en Mora Sin Impulsa" (`leg/com/rma/adm/cmg-mora-simp-m`). */
@Component({
  selector: 'app-mensual-cmg-cartera-mora-sin-impulsa',
  standalone: true,
  imports: [ReporteSimpleComponent, SelectFiltroComponent],
  templateUrl: './cmg-cartera-mora-sin-impulsa.component.html',
  styleUrl: './cmg-cartera-mora-sin-impulsa.component.css',
})
export class CmgCarteraMoraSinImpulsaComponent extends ReporteSimpleBase {
  ...
  protected override consultar(nodo: NodoConsulta): Observable<ReporteBloqueUnico> {
    return this.servicio.cmgCarteraMoraSinImpulsa(nodo, this.fechaBase());
  }
}
