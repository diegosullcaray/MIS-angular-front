...
describe('CeroCuotasService', () => {
  let service: CeroCuotasService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(CeroCuotasService);
  });

  it('obtenerCeroCuotas() pide el único bloque por el path completo del legado, vía getDeprecatedData', () => {
    service.obtenerCeroCuotas({ tip_cod: 2, cod_rel: '12345678' }).subscribe();

    expect(reportesFalso.getDeprecatedData).toHaveBeenCalledWith('rda/sectorista/cero_cuota/cero_cuota_sec_01', {
      tip_cod: 2,
      cod_rel: '12345678',
    });
  });
