...
@Component({
  ...
  styleUrl: './clientes-producto.component.css',
})
export class ClientesProductoComponent {
  ...
  protected onAsesorSeleccionado(asesor: AsesorSec | null): void {
    ...
    this.servicio.obtenerClientesProducto({ tip_cod: 2, cod_rel: asesor.dni }).subscribe({
