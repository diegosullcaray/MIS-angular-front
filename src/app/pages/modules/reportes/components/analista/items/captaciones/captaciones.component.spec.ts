...
describe('CaptacionesComponent', () => {
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [{ provide: AsesorSecService, useValue: { obtenerAsesores: servicioFalso.obtenerAsesores } }, { provide: CaptacionesService, useValue: servicioFalso }, ToastService, PrimeNgMessageService],
    });
  });
