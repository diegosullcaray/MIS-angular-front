...
const COLUMNAS: DataTableColumn[] = [
  ...
  { field: 'HCODOPE', header: 'Operación', align: 'center', filterType: 'text' },
  { field: 'HFECDES', header: 'Fec. Desembolso', align: 'center', filterType: 'date' },
  { field: 'HMONDES', header: 'Monto Desembolso', align: 'right', filterType: 'number' },
  { field: 'HFECVIS', header: 'Fecha Visita', align: 'center', filterType: 'date' },
  {
    field: 'HCUMPLDC',
