...
const COLUMNAS: DataTableColumn[] = [
  { field: 'des_sec', header: 'Asesor', width: '14rem', filterType: 'text' },
  { field: 'des_uni', header: 'Unidad', width: '12rem', filterType: 'text' },
  { field: 'des_cor', header: 'Corredor', width: '12rem', filterType: 'text' },
  { field: 'des_ter', header: 'Territorio', width: '12rem', filterType: 'text' },
];
