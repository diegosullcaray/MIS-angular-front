...
describe('MaxFilasDirective', () => {
  ...
  it('con más de 14 filas limita el alto al pie de la fila 14 y saca scroll interno', () => {
  ...
  it('con 14 filas o menos deja la tabla con su alto natural', () => {
  ...
  it('nunca pasa del tope de alto de la ventana, aunque haya menos de 14 filas', () => {
