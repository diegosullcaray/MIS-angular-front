...
- Name: actividad-diaria-lote-03.spec.ts >> Actividad Diaria — smoke del lote 03 >> Resumen de Movilidad Comercial resuelve en /app/reportes/leg/com/rda/adm/res-mov
...
Locator: getByRole('heading', { name: 'Resumen de Movilidad Comercial', exact: true })
Expected: visible
Error: element(s) not found

Call log:
  - Expect "toBeVisible" with timeout 5000ms
  - waiting for getByRole('heading', { name: 'Resumen de Movilidad Comercial', exact: true })
  - Test timeout of 30000ms exceeded.

```

```yaml
- complementary "Sistemas":
  - link "MIS — ir al inicio":
    - /url: /app/dashboard
    - img "MIS"
  ...
  - navigation:
    - list:
      ...
      - listitem:
        - img
      - listitem: Mi espacio
  - button "Activar modo claro" [pressed]
  - button "Comunicados del sistema"
  - button "UE Usuario E2E"
- main:
  - region "Reportes recientes":
    - heading "Reportes recientes" [level=2]
    - paragraph: Todavía no abriste ningún reporte. Abre uno desde el menú lateral y quedará aquí.
```
