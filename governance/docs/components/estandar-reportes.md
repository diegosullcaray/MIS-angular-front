...
- **12 filas visibles como máximo, y nunca más del 55 % del alto de la ventana.** Pasado eso la
  ...
  (`shared/ui/tablas/max-filas.directive.ts`), que mide hasta el pie de la fila 12 y aplica el tope
