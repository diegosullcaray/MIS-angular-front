...
- **14 filas visibles como máximo, y nunca más del 62 % del alto de la ventana.** Pasado eso la
  ...
  (`shared/ui/tablas/max-filas.directive.ts`), que mide hasta el pie de la fila 14 y aplica el tope
