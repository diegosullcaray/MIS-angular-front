...
<!-- Generado por governance/scripts/generar-inventario.mjs — 2026-09-25 · commit 4c901647. No editar a mano. -->

- **342** archivos `*.spec.ts` bajo `src/app`.
- **34** suites Playwright bajo `e2e/`.
