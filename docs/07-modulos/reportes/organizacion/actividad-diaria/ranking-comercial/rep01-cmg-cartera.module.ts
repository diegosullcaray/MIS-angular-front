...
import { Rep01RankingComercialRoutingModule } from "./rep01-ranking-comercial-routing.module";
 


@NgModule({
    imports:[
        Rep01RankingComercialRoutingModule,
...
export class Rep01RankingComercialModule{} 