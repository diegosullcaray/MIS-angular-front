...
import { Rep01ProductosMisonalesRoutingModule } from "./rep01-productos-misionales-routing.module";


@NgModule({
    imports:[
        Rep01ProductosMisonalesRoutingModule,
...
export class Rep01ProductosMisionalesModule{} 