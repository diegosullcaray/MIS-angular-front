...
import { Rep01MonIntComercialRoutingModule } from "./rep01-mon-inte-comer-routing.module";
...
@NgModule({
    imports:[
        Rep01MonIntComercialRoutingModule,
...
export class Rep01MonIntComercialModule{} 