...
import { Rep01PoblacionMisionalRoutingModule } from "./rep01-poblacion-misional-routing.module";


@NgModule({
    imports:[
        Rep01PoblacionMisionalRoutingModule,
...
export class Rep01PoblacionMisionalModule{} 