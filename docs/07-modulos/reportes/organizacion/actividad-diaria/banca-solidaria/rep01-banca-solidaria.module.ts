...
import { Rep01BancaSolidariaRoutingModule } from "./rep01-banca-solidaria-routing.module"; 
...
@NgModule({
    imports:[
        Rep01BancaSolidariaRoutingModule,
...
export class Rep01BancaSolidariaModule{} 