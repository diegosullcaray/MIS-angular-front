...
import { Rep01GestionComercialRoutingModule } from "./rep01-gestion-comercial-routing.module"; 
...
@NgModule({
    imports:[
        Rep01GestionComercialRoutingModule,
...
export class Rep01GestionComercialModule{} 