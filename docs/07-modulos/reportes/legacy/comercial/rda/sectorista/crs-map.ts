...
import { GCOVID_OPT01, Semana01, Tipbase, Tramo01, Boolean01, TramoVenc01, Producto01, GRUPCIIU, renderDates_1, renderDates_3 } from '../../../support/common/filter-locale.module';
  ...
  },
  {
    ...
    table:[
      { id:'_01',
        ...
        params: { fec: fec_day_ult },
        content: {
          higher: '<h2 class="title-module">El segmento SIN SEGMENTO "no es excluyente, cliente puede participar" </h2>',
          lower: '<b></b>' 
        }        
      } 
    ]
