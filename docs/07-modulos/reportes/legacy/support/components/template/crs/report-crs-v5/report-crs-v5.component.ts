...
@Component({
  selector: 'app-report-crs-v5',
  templateUrl: './report-crs-v5.component.html',
  styleUrls: ['./report-crs-v5.component.scss']
})
export class ReportCrsv5Component implements OnDestroy,OnInit {
  title_module:string;
  report:ReportT;
  config:string[];
