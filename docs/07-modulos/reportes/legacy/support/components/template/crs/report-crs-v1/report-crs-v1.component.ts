...
@Component({
  selector: 'app-report-crs-v1',
  templateUrl: './report-crs-v1.component.html',
  styleUrls: ['./report-crs-v1.component.scss']
})
export class ReportCrsV1Component implements OnDestroy,OnInit {
  title_module:string;
  report:ReportT;
  config:string[];
