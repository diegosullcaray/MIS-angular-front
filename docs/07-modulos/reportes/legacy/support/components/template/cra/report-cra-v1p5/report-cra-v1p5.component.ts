...
@Component({
  selector: 'app-report-cra-v1p5',
  templateUrl: './report-cra-v1p5.component.html',
  styleUrls: ['./report-cra-v1p5.component.scss']
})
export class ReportCraV1p5Component implements OnInit, OnDestroy {
  report: ReportT;
