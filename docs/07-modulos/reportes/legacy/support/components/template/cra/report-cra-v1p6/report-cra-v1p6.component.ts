...
@Component({
  selector: 'app-report-cra-v1p6',
  templateUrl: './report-cra-v1p6.component.html',
  styleUrls: ['./report-cra-v1p6.component.scss']
})
export class ReportCraV1p6Component implements  OnInit,OnDestroy {
  report: ReportT;
  activeHier: boolean;
  confHier1: any;
