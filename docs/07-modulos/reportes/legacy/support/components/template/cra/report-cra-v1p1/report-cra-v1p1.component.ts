...
@Component({
  selector: 'app-report-cra-v1p1',
  templateUrl: './report-cra-v1p1.component.html',
  styleUrls: ['./report-cra-v1p1.component.scss']
})
export class ReportCraV1p1Component implements OnInit, OnDestroy {
  report: ReportT;
  activeHier: boolean;
  confHier1: any;
