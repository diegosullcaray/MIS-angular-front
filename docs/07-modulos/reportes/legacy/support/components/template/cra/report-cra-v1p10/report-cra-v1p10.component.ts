...
@Component({
  selector: 'app-report-cra-v1p10',
  templateUrl: './report-cra-v1p10.component.html',
  styleUrls: ['./report-cra-v1p10.component.scss']
})
export class ReportCraV1p10Component implements OnInit, OnDestroy {
  report: ReportT;
  activeHier: boolean;
  confHier1: any;
  ...
  private combineSelections() {
    combineLatest([this.filter$, this.level$]).subscribe(([filter, level]) => {
      ...
      this.renderTable(params, { find: '_04', index: 0 })
      this.renderTable_1(params, { find: '_05', index: 1 })
      this.renderTable_1(params, { find: '_01', index: 2 })
      this.renderTable_1(params, { find: '_02', index: 3 })
      this.renderTable_1(params, { find: '_03', index: 4 })
      //this.renderTable_1(params, { find: '_05', index: 4 })
