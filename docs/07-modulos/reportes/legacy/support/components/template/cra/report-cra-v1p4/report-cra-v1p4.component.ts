...
@Component({
  selector: 'app-report-cra-v1p4',
  templateUrl: './report-cra-v1p4.component.html',
  styleUrls: ['./report-cra-v1p4.component.scss']
})
export class ReportCraV1p4Component implements OnInit, OnDestroy {
  report: ReportT;
