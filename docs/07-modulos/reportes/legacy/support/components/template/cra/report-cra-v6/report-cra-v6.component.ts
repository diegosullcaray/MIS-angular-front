...
@Component({
  selector: 'app-report-cra-v6',
  templateUrl: './report-cra-v6.component.html',
  styleUrls: ['./report-cra-v6.component.scss']
})
export class ReportCraV6Component implements OnInit, OnDestroy {
  report: ReportT;
  activeHier: boolean;
  confHier1: any;
