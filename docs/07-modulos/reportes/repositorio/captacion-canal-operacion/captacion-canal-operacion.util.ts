...
export const tableHeaders = [
    ...
    },
    {
        ...
        subs:[
            {
                label:'Monto',
                key:'monto_pas_caract_AHORROS_2',
                type:'number',
                style: {
                    'min-width': '85px',
                    'max-width': '85px'
            ...
            {
                label:'Clientes',
                key:'numcli_pas_caract_AHORROS_2',
                type:'number',
                style: {
                    'min-width': '85px',
                    'max-width': '85px'
    ...
    },
    {
        ...
        subs:[
            {
                label:'Monto',
                key:'monto_pas_caract_PLAZO FIJO_2',
                style: {
                    'min-width': '85px',
                    'max-width': '85px'
                },
            ...
            {
                label:'Clientes',
                key:'numcli_pas_caract_PLAZO FIJO_2',
                style: {
                    'min-width': '85px',
                    'max-width': '85px'
                },
