...
@Component({
    selector: 'app-seguro-optativo.component',
    templateUrl: './seguro-optativo.component.html',
    styleUrls: ['./seguro-optativo.component.scss']
})
export class SeguroOptativoComponent implements OnInit {
