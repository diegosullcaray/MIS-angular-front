...
import { filter1, tableConfOPTS, tableConfOPTS2 } from './panel-misionales.util';
import { BehaviorSubject, Subject, combineLatest } from 'rxjs';
import { prepareDataForPagination } from 'app/shared/components/stg-paginator/stg-paginator.util';
import { StgPaginatorComponent } from 'app/shared/components/stg-paginator/stg-paginator.component';

@Component({
    selector: 'app-panel-misionales.component',
    templateUrl: './panel-misionales.component.html',
    styleUrls: ['./panel-misionales.component.scss']
})
export class panelMisioanlesComponent implements OnInit {
 ...
 //Quinto
        this.antRep.getRegularTableResult("prod_misi_05", { "tip_cod": tipcod, "cod_rel": codrel, "fec": this.currentDate, "prod": prod}).subscribe(

            x => {
                let r5 = x.body.resultado;
                //console.log(r3)
                this.dataSource5 = r5.data;
                this.headerDefs5 = JSON.parse(r5.headers); 
                this.load2.next(true);
                //this.loading = false;
                //this.loader.close(); 
            }
