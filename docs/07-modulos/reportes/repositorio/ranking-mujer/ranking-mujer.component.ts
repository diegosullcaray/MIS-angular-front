...
import { filter1, filter2, filter3, tableConfOPTS, tableConfOPTS2 } from './ranking-mujer.util';
...
@Component({
    selector: 'app-ranking-mujer.component',
    templateUrl: './ranking-mujer.component.html',
    styleUrls: ['./ranking-mujer.component.scss']
})
export class rankingMujerComponent implements OnInit {
    ...
    loadData() {
        ...
        this.antRep.getRegularTableResult("RS_RANK_MUJ_01", { "tip_cod": tipcod, "cod_rel": codrel, "fec": this.currentDate}).subscribe(
        ...
        // Segunda Tabla 
        this.antRep.getRegularTableResult("RS_RANK_MUJ_02", { "tip_cod": tipcod, "cod_rel": codrel, "fec": this.currentDate }).subscribe(
