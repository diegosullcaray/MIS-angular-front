...
@Component({
    selector: 'app-zplantilla.component',
    templateUrl: './zplantilla.component.html',
    styleUrls: ['./zplantilla.component.scss']
})
export class zplantillaComponent implements OnInit {
