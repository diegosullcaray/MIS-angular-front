...
@Component({
    selector: 'app-reasignado.component',
    templateUrl: './reasignado.component.html',
    styleUrls: ['./reasignado.component.scss']
})
export class reasignadoComponent implements OnInit {
    ...
    ngOnInit(): void {
        ...
        this.showFilterSinAsignar= true;
    ...
    onTabChanged(evt:any){
        ...
        this.showFilterSinAsignar = evt.index==2?false:true 
    }
