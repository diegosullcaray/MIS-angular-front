...
### Existentes (en `../05-referencia/figma/`)
...
| Capa | Decisión |
|---|---|
| **Backend** | Spring Boot 3 (monolito modular) + PostgreSQL — ver [Backend Schema](./01-backend-schema.md) y [Database Schema](./02-database-schema.sql) |
